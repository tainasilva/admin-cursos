...
<form action="{{url('cursos')}}/update/{{ $curso->id }}" method="POST" class="form-horizontal">
{{ csrf_field() }}
{{ method_field('PUT') }}
<fieldset>

<!-- Form Name -->
<legend>Edição Curso</legend>
...
<div class="col-md-4">
<input id="nome" name="nome" value="{{$curso->nome}}" placeholder="Nome" class="form-control input-md" required="" type="text">
